    ...
    <div class="mx-auto flex w-full max-w-md flex-col gap-8 p-6 lg:p-8">
        ...
        <div class="flex flex-col gap-6">
            ...
            <div class="flex flex-col gap-3 rounded-lg border border-[#19140035] bg-white p-5 shadow-sm dark:border-[#3E3E3A] dark:bg-[#161615]">
                <h2 class="font-semibold">Create a New Table</h2>
                <p class="text-sm text-[#706f6c] dark:text-[#A1A09A]">
                    Start a new game and invite friends with a link.
                </p>
                <button
                    type="button"
            ...
            {{-- Join Table --}}
            <div class="flex flex-col gap-3 rounded-lg border border-[#19140035] bg-white p-5 shadow-sm dark:border-[#3E3E3A] dark:bg-[#161615]">
                <h2 class="font-semibold">Join a Table</h2>
                <p class="text-sm text-[#706f6c] dark:text-[#A1A09A]">
                    Enter a 6-character table code to join an existing game.
                </p>
